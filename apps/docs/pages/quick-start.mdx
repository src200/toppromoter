...
### Adding the Reflio script to your website
...
```html copy
<script async src='https://toppromoter.vercel.app/js/toppromoter.min.js' data-reflio='<your_company_id>'></script> 
```
...
**You should do this for every sign up to make sure you catch all valid referrals. It doesn't matter if you send every single sign up to Reflio, regardless of if they have a referral cookie set or not, our system will only save users who signed up after visiting a referral link, and has a valid cookie in their browser.**
